...
if(isset($_POST['add']))
{
	...
	$sql = "UPDATE property SET title= '{$title}', pcontent= '{$pcontent}', type='{$type}', bhk='{$bhk}', stype='{$stype}',
	floor='{$floor}',price='{$price}', city='{$city}', state='{$state}',asize='{$asize}',address='{$loc}', feature='{$feature}',
	uid='{$uid}', status='{$status}',isFeatured='{$isFeatured}' WHERE pid = {$pid}";
	
	$result=mysqli_query($con,$sql);
	if($result == true)
	{
		$msg="<p class='alert alert-success'>Property Updated</p>";
		header("Location:v_feature.php?msg=$msg");
	}
	else{
								...
								<div class="description">
									...
									<?php echo $msg; ?>
										...
										<div class="row">
											<div class="col-xl-12">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<textarea class="tinymce form-control" name="pcontent" value="<?php echo $row['2']; ?>" rows="10" cols="30"></textarea>
													</div>
												</div>
											...
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="type" value="<?php echo $property['type']; ?>">
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="price" value="<?php echo $row['8']; ?>" required placeholder="Enter Price">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">City</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="city" value="<?php echo $row['9']; ?>" required placeholder="Enter City">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">State</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="state" value="<?php echo $row['10']; ?>" required placeholder="Enter State">
													</div>
												</div>
											</div>
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="asize" value="<?php echo $row['7']; ?>" required placeholder="Enter Area Size (in sqrt)">
													</div>
												</div> 
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Address</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="loc" value="<?php echo $row['11']; ?>" required placeholder="Enter Address">
													</div>
												</div>
										...
										<div class="form-group row">
											...
											<textarea class="tinymce form-control" value="<?php echo $row['12']; ?>" name="feature" rows="10" cols="30">
												<!---feature area start--->
												<div class="col-md-4">
														<ul>
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input class="form-control" name="uid" value="<?php echo $row['18']; ?>" type="int" required="">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Status</label>
													<div class="col-lg-9">
														<select class="form-control" value="<?php echo $row['19']; ?>" required name="status">
															<option value="">Select Status</option>
