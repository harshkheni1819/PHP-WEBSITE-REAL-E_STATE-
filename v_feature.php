					...
					<table class="items-list col-lg-12 table-hover" style="border-collapse:inherit;">
                        <thead>
                             <tr  class="bg-dark">
                                ...
                                <th class="text-white font-weight-bolder">Availablility</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="property-info d-table">
                                        ...
                                        <div class="price mt-3">
											<span class="text-success">$&nbsp;<?php echo $row['8'];?></span>
										</div>
                                    </div>
								</td>
                                ...
                                <td><a class="btn btn-info" href="v_submitpropertyupdate.php?id=<?php echo $row['0'];?>">Update</a></td>
								<td><a class="btn btn-danger" href="v_submitpropertydelete.php?id=<?php echo $row['0'];?>">Delete</a></td>
                            </tr>
							<?php } ?>
