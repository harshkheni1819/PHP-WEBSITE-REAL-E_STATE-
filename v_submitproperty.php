...
if(isset($_POST['add']))
{
	...
	$temp_name4 =$_FILES['pimage4']['tmp_name'];
		...
		$sql="insert into property (title,pcontent,type,bhk,stype,floor,price,city,state,address,feature,pimage,pimage1,pimage2,pimage3,pimage4,uid,status,isFeatured) values('$title','$pcontent','$type','$bhk','$stype','$floor','$price','$city','$state','$loc','$feature','pimage','$pimage1','$pimage2','$pimage3','$pimage4','$uid','$status','$isFeatured')";
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input class="form-control" name="pimage2" type="file">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Image 4</label>
													<div class="col-lg-9">
														<input class="form-control" name="pimage4" type="file">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">uid</label>
													<div class="col-lg-9">
														<input class="form-control" name="uid" type="int" required="">
													</div>
												</div>
												<div class="form-group row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input class="form-control" name="pimage1" type="file" >
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">image 3</label>
													<div class="col-lg-9">
														<input class="form-control" name="pimage3" type="file" >
													</div>
												</div>
