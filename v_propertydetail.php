            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <span class="mb-sm-20 d-block text-capitalize"><i class="fas fa-map-marker-alt text-success font-12"></i> &nbsp;<?php echo $row['11'];?></span>
							</div>
                            <div class="col-md-6">
                                ...
                                <table class="w-100">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>Total Floor :</td>
                                            <td class="text-capitalize"><?php echo $row['20'];?></td>
                                        </tr>
                                        <tr>
                                            <td>City :</td>
                                    ...
                                    <div class="col-sm-8 col-lg-9">
                                        <div class="agent-data text-ordinary mt-sm-20">
                                            ...
                                            <ul class="mb-3">
                                                ...
                                                <button><a href="https://mail.google.com/mail/mu/mp/800/#co" class="nav-item nav-link">Contact Now</a></button>
                                                
                                            </ul>
                                            
                                            <div class="mt-3 text-secondary hover-text-success">
                                                <ul>
                                                <li class="float-left mr-3"><a href="https://www.facebook.com/login/?privacy_mutation_token=eyJ0eXBlIjowLCJjcmVhdGlvbl90aW1lIjoxNjkyNjgxOTczLCJjYWxsc2l0ZV9pZCI6MjY5NTQ4NDUzMDcyMDk1MX0%3D"><i class="fab fa-facebook-f"></i></a></li>
                                                    <li class="float-left mr-3"><a href="https://twitter.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoiZW4ifQ%3D%3D%22%7D"><i class="fab fa-twitter"></i></a></li>
                                                    <li class="float-left mr-3"><a href="https://accounts.google.com/v3/signin/identifier?continue=http%3A%2F%2Fsupport.google.com%2Fanswer%2F2451065%3Fhl%3Den&ec=GAZAdQ&hl=en&ifkv=AXo7B7WeWoNd7jTh4DXFQqHMifQmwO-bXc1FTe1Lcl7C63tyDy9wLpiAPT1tP_W21VwSr6YgaeCU7w&passive=true&sjid=942555564413464270-AP&flowName=GlifWebSignIn&flowEntry=ServiceLogin&dsh=S285763972%3A1692682147978110"><i class="fab fa-google-plus-g"></i></a></li>
                                                    <li class="float-left mr-3"><a href="https://in.linkedin.com/?original_referer=https%3A%2F%2Fwww.google.com%2F"><i class="fab fa-linkedin-in"></i></a></li>
                    ...
                    <div class="col-lg-4">
                        ...
                        <form class="d-inline-block w-100" action="v_calc.php" method="post">
