                        ...
                        <div class="sidebar-widget mt-5">
                            ...
                            <ul class="property_list_widget">
                                ...
                                <li> <img src="admin/property/<?php echo $row['14'];?>" alt="pimage">
                                    <h6 class="text-secondary hover-text-success text-capitalize"><a href="v_propertydetail.php?pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h6>
                                    <span class="font-14"><i class="fas fa-map-marker-alt icon-success icon-small"></i> <?php echo $row['11'];?></span>
