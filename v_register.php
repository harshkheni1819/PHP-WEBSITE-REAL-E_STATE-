                	...
                	<div class="loginbox">
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<div class="text-center dont-have">Already have an account? <a href="v_login.php">Login</a></div>
								<div class="text-center dont-have">User Register <a href="register.php">Register</a></div>
